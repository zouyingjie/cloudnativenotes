import{_ as p,r as i,o,c,a as l,b as s,d as a,e as t}from"./app-BTSCaQUU.js";const u={},r={href:"https://kubernetes.github.io/ingress-nginx/user-guide/nginx-configuration/annotations/#canary",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/megaease/easemesh",target:"_blank",rel:"noopener noreferrer"};function m(k,n){const e=i("ExternalLinkIcon");return o(),c("div",null,[n[4]||(n[4]=l(`<h1 id="控制器对象" tabindex="-1"><a class="header-anchor" href="#控制器对象" aria-hidden="true">#</a> 控制器对象</h1><p>在使用 Kubernetes 时，我们通常是使用各种 Controller 对象来管理 Pod。 每个 Controller 本质上就是观察对象状态并进行状态拟合的控制循环。每个 Controller 都是一个单独的进程，试图将对象的状态调整为其所期望的状态。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">for</span> <span class="token punctuation">{</span>
